# 使い方
git clone して全ファイル取ってきたら 7zip で 001.zip を解凍してください。

# 入れたドライバ
- https://vibsdepot.v-front.de/wiki/index.php/Net55-r8168 (RTL8111とか)
...
- https://flings.vmware.com/community-networking-driver-for-esxi (IntelNUC向け,1.2.7)
ファイル名: VMW_bootbank_net-community_1.2.7.0-1vmw.700.1.0.15843807.vib

# どうやって作られたか
PowerCLI から ESXi-Cusomizer-PS-v2.8.1.ps1 を以下形式で実行
...
試した当時最新は2.9.0、しかしPowerCLI 6.5.0 とかみ合わないのかうまくいかず
